...
/// LAB STAFF PROFILE
/// - Editable: name, phone
/// - Read-only: email (login)
/// - Change password + Logout
/// (Receptionist profile ka same pattern)
class LabStaffProfileScreen extends StatefulWidget {
  const LabStaffProfileScreen({super.key});

  @override
  State<LabStaffProfileScreen> createState() => _LabStaffProfileScreenState();
}

class _LabStaffProfileScreenState extends State<LabStaffProfileScreen> {
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const SizedBox(height: 12),
          Text(name.isEmpty ? 'Lab Staff' : name,
              style: const TextStyle(
                  fontSize: 18,
                  fontWeight: FontWeight.w700,
                  color: Colors.white)),
...
// ── Change Password (patient/receptionist wale jaisa) ──
